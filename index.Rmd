...
4. Sorot semua baris kode (kecuali komentar jika mau), lalu tekan **Ctrl + Enter** (Windows/Linux) atau **Cmd + Enter** (Mac)
5. Perhatikan jendela *Console* - Anda akan melihat hasil eksekusi kode Anda
6. Selamat! Anda baru saja membuat file kode sumber R pertama Anda yang dapat disimpan dan dijalankan kapan saja.
:::

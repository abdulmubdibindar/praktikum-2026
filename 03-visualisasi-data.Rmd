...
1.  Kumpulkan kembali fail modul ini yang sudah lengkap dengan hasil pengerjaannya. [STP-3.3]{.capaian}
2.  Tuliskan interpretasi kalian terhadap setiap diagram yang dihasilkan dalam modul ini. [STP-3.2]{.capaian}
3.  Buatlah diagram yang tepat untuk variabel `biaya.dalam.sepekan`. [STP-3.1]{.capaian}
4.  Mengapa Anda memilih diagram seperti yang Anda lakukan di nomor 3? Perhatikan tingkat pengukuran variabel dan jenis nilai dari variabel tersebut! [STP-3.4]{.capaian}
